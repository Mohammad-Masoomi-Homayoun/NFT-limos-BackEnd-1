...
@Service
public class MintTrackerService {
    ...
    public MintTrackerService(NiftyLimosService niftyLimosService, StateService service) {
    ...
    synchronized protected void scan() throws IOException {
