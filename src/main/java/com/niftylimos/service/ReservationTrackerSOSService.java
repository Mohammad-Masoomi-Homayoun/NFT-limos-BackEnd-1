...
@Service
@Transactional
public class ReservationTrackerSOSService {
    private static final Logger logger = LoggerFactory.getLogger(ReservationTrackerSOSService.class);
    ...
    public ReservationTrackerSOSService(NiftyLimosService niftyLimosService, StateService service) {
    ...
    private long getLastCheckedBlock() {
        var stringValue = stateService.get("reservation-sos-tracker-last-checked-block");
    ...
    private void setLastCheckedBlock(Long newValue) {
        stateService.set("reservation-sos-tracker-last-checked-block", newValue.toString());
    }
